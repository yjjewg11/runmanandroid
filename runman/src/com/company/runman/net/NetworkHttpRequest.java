...
public class NetworkHttpRequest {
    ...
    public static HttpReturn executeHttpGet(String urlString) {
        ...
        try {
            ...
            TraceUtil.traceThrowableLog(e);
            ret.code = 400;
            ret.err =e.getClass().getName()+ ":"+e.getMessage();
            return ret;
        }
        ...
        try {
            ...
            TraceUtil.traceThrowableLog(e);
            LogHelper.e(TAG, "NetworkHttpRequest executeHttpGet 1 IOException urlString :" + urlString, e);
...
//                    }
            ...
            TraceUtil.traceThrowableLog(e);
            LogHelper.e(TAG, "NetworkHttpRequest executeHttpPost 1 IOException urlString :" + urlString, e);
            ret.code = Constant.ResponseCode.TIMEOUT;
            ret.err = e.getMessage();
        } catch (Exception e) {
            TraceUtil.traceThrowableLog(e);
    ...
    public static HttpReturn executeHttpPut(Context context, String urlString, String post) {
        ...
        try {
            ...
            TraceUtil.traceThrowableLog(ioe);
...
//                    ret.setBytes(responseStr.getBytes(HTTP.UTF_8));
    ...
    public static HttpReturn uploadFileByBitmap(Bitmap bitmap, String RequestURL) {
        ...
        try {
            ...
            if (bitmap != null) {
                ...
                ByteArrayOutputStream baos = new ByteArrayOutputStream();
                bitmap=ImgUtils.imageZoom(bitmap);
