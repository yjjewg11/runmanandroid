 ...
 */
public abstract class AbstractSaveAsyncTask extends AbstractAsyncTask<String, Void, Object> {
    static String TAG="AbstractSaveAsyncTask";
    private AbstractJsonform form;
    private BaseActivity mContext;
    private String saveurl;
    //  String url="rest/trainingCourse/save.json";
    protected AbstractSaveAsyncTask(AbstractJsonform form, BaseActivity mContext,String saveurl) {
        this.form = form;
