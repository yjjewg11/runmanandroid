...
//            }
    ...
    private class SaveAsyncTask extends AbstractAsyncTask<String, Void, Object> {
        ...
        protected SaveAsyncTask(TrainingCourseJsonform form, TrainingCourseDetailSubscribeActivity trainingCourseEditActivity) {
            this.form = form;
            this.trainingCourseEditActivity=trainingCourseEditActivity;
        }

        private TrainingCourseDetailSubscribeActivity trainingCourseEditActivity;
