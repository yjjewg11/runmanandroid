...
public abstract class AbstractAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory THREAD_FACTORY = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "LeAsyncTask #" + mCount.getAndIncrement());
        }
    };

    private static final ThreadPoolExecutor sExecutor = new ThreadPoolExecutor(CORE_POOL_SIZE, MAXIMUM_POOL_SIZE,
            KEEP_ALIVE, TimeUnit.SECONDS, WORK_QUEUE, THREAD_FACTORY);
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link AbstractAsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
    ...
    public AbstractAsyncTask() {
        mWorker = new WorkerRunnable<Params, Result>() {
            ...
            public Result call() {
                ...
                return doInBackground(getParams());
            }
        };
        ...
        mFuture = new FutureTask<Result>(mWorker) {
            ...
            protected void done() {
                ...
                sendMessage(MESSAGE_POST_RESULT, result);
            }
        };
    }
     ...
     *
     * @param params The parameters of the task.
     * @return This instance of LeAsyncTask.
     * @throws IllegalStateException If {@link #getStatus()} returns either
     *                               {@link AbstractAsyncTask.Status#RUNNING} or
     *                               {@link AbstractAsyncTask.Status#FINISHED}.
     */
    public final AbstractAsyncTask<Params, Progress, Result> execute(Params... params) {
    ...
    protected final void publishProgress(Progress... values) {
        sHandler.obtainMessage(MESSAGE_POST_PROGRESS,
                new LeAsyncTaskResult<Progress>(this, values)).sendToTarget();
    }
    ...
    public void sendMessage(int what, Result... results) {
        LeAsyncTaskResult<Result> leResult = new LeAsyncTaskResult<Result>(this, results);
        Message message = AbstractAsyncTask.sHandler.obtainMessage(what, leResult);
    ...
    private static final class InternalHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            LeAsyncTaskResult<?> result = (LeAsyncTaskResult<?>) msg.obj;
            switch (msg.what) {
    ...
    public static class LeAsyncTaskResult<Data> {
        private final AbstractAsyncTask mTask;
        private final Data[] mData;

        LeAsyncTaskResult(AbstractAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
