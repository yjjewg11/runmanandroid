 ...
 */
@SuppressLint("NewApi")
public class MonitorStationEditGridView extends GridView {
    /**
     * MonitorStationEditGridView， 默认是1000毫秒，也可以自行设置
     */
    ...
    public MonitorStationEditGridView(Context context) {
        this(context, null);
    }

    public MonitorStationEditGridView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MonitorStationEditGridView(Context context, AttributeSet attrs, int defStyle) {
